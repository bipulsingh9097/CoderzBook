	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				${alreadyexist }
					<!-- Content Row -->
					<form action="saveEmployee" class="form-horizontal" method="post">
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="col-lg-4">
									...
									<div class="col-lg-6">
									<input name="dob" class="form-control form-control-user ml-2" id="exampleFirstname" type="date" />
								   </div>
								</div>	
